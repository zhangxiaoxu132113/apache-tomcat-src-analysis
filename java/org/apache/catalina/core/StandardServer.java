...
public final class StandardServer extends LifecycleMBeanBase implements Server {
    ...
    /**
     * 【分析】：
     * 通过代码得知，StandardServer的startInternal方法中做了一下操作
     * 1，new一个LifecycleEvent周期事件，通知事件的监听者；其实这里就是一个观察者模式
     * 2，设置自己的LifecycleState为Starting
     * 3，NamingResourcesImpl也调用了自己的startInternal方法，也是修改了自己的LifecycleState为Starting，并通知事件监听者
     * 4，最重要的一个步骤，启动多个Service
     *
